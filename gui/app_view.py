...
class AppView(ft.View):
    ...
    def __init__(self, view_model: AnalysisViewModel, tr: Callable[[str, ...], str]):
        ...
        input_source_section = ft.Card(
            content=ft.Container(
                ...
                content=ft.Column(
                    [
                        ft.Text(
                            self.tr("input_source_title"),
                            style=ft.TextThemeStyle.TITLE_MEDIUM,
                        ),
                        ft.RadioGroup(
                            ref=self.source_type_ref,
                            value="file"
                            if self.view_model.get_config_value("file")
                            else "url",
                            content=ft.Row(
                                [
                                    ft.Radio(
                                        value="file", label=self.tr("file_option")
                                    ),
                        ...
                        ft.TextField(
                            ref=self.url_ref,
                            label=self.tr("youtube_url_label"),
                        ...
                        content=ft.Column(
                            [
                                ft.Row(
                                    [
                                        ft.TextField(
                                            ref=self.sing_ref_time_ref,
                                            label=self.tr("sing_ref_time_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "singing_ref_time"
                                                )
                                            ),
                                            width=150,
                                        ...
                                        ft.TextField(
                                            ref=self.non_sing_ref_time_ref,
                                            label=self.tr("non_sing_ref_time_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "non_singing_ref_time"
                                                )
                                            ),
                                            width=150,
                                            keyboard_type=ft.KeyboardType.NUMBER,
                                        ...
                                        ft.TextField(
                                            ref=self.ref_duration_ref,
                                            label=self.tr("ref_duration_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "ref_duration"
                                                )
                                ...
                                ft.Row(
                                    [
                                        ft.TextField(
                                            ref=self.hmm_threshold_ref,
                                            label=self.tr("hmm_thresh_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "hmm_threshold"
                                                )
                                        ...
                                        ft.TextField(
                                            ref=self.min_segment_duration_ref,
                                            label=self.tr("min_seg_dur_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                        ...
                                        ft.TextField(
                                            ref=self.min_segment_gap_ref,
                                            label=self.tr("min_seg_gap_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "min_segment_gap"
                                                )
                                        ...
                                        ft.TextField(
                                            ref=self.n_components_ref,
                                            label=self.tr("pca_comp_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "n_components"
                                                )
                                ...
                                ft.Row(
                                    [
                                        ft.TextField(
                                            ref=self.min_duration_for_id_ref,
                                            label=self.tr("min_id_dur_label"),
                                            value=str(
                                                self.view_model.get_config_value(
                                                    "min_duration_for_id"
                                                )
                                        ...
                                        ft.Dropdown(
                                            ref=self.whisper_model_ref,
                                            label=self.tr("whisper_model_label"),
                                            value=self.view_model.get_config_value(
                                                "whisper_model"
                                            ),
                                            width=150,
                                            options=[
                                        ...
                                        ft.Checkbox(
                                            ref=self.enable_hpss_ref,
                                            label=self.tr("enable_hpss_checkbox"),
                                            value=self.view_model.get_config_value(
                                                "enable_hpss"
                                            ),
                                        ),
                                        ft.TextField(
                                            ...
                                            label=self.tr("gemini_api_key_label"),
                                            value=self.view_model.get_config_value(
                                                "gemini_api_key"
                                            ),
                                            password=True,
                                ...
                                ft.Row(
                                    [
                                        ft.TextField(
                                            ref=self.output_dir_ref,
                                            label=self.tr("output_dir_label"),
                                            value=self.view_model.get_config_value(
                                                "output_dir"
                                            ),
                                            expand=True,
                                ...
                                ft.Row(
                                    [
                                        ft.Checkbox(
                                            ref=self.save_json_ref,
                                            label=self.tr("save_json_checkbox"),
                                            value=self.view_model.get_config_value(
                                                "save_results_json"
                                            ),
                                        ),
                                        ft.Checkbox(
                                            ref=self.save_csv_ref,
                                            label=self.tr("save_csv_checkbox"),
                                            value=self.view_model.get_config_value(
                        ...
                        ft.Row(
                            [
                                ft.ElevatedButton(
                                    ...
                                    on_click=self._start_analysis_clicked,
                                    width=200,
                                    tooltip=self.tr(
                                        "start_button_tooltip"
                                    ),  # Text set in update_view_state
                                ),
                                ft.ProgressBar(
        ...
        results_section = ft.Tabs(
            ...
            tabs=[
                ft.Tab(
                    text=self.tr("detected_segments_tab"),
                        ...
                        [
                            ft.Container(
                                content=ft.DataTable(
                                    ...
                                    columns=[
                                        ft.DataColumn(
                                            ft.Text(self.tr("segment_col_num"))
                                        ),
                                        ft.DataColumn(
                                            ft.Text(self.tr("segment_col_start"))
                                        ),
                                        ft.DataColumn(
                                            ft.Text(self.tr("segment_col_end"))
                                        ),
                                        ft.DataColumn(
                                            ft.Text(self.tr("segment_col_duration"))
                                        ),
                                    ],
                                    rows=[],
                                    column_spacing=20,
                            ...
                            ft.Text(
                                self.tr("summary_label"), weight=ft.FontWeight.BOLD
                            ),
                            ft.Text(
                                self.tr("summary_no_analysis"),
                                ref=self.summary_text_ref,
                            ),
                        ],
                ...
                ft.Tab(
                    text=self.tr("identified_songs_tab"),
                ...
                ft.Tab(
                    text=self.tr("actions_tab"),
                    icon=ft.icons.SETTINGS_APPLICATIONS,
                    content=ft.Row(
                        [
                            ft.ElevatedButton(
                                self.tr("save_results_button"),
                                ref=self.save_button_ref,
                                icon=ft.icons.SAVE_ALT,
                                on_click=self._save_results_clicked,
        ...
        log_section = ft.Column(
            [
                ...
                ft.Container(
                    content=ft.ListView(
                        ref=self.log_view_ref, height=150, spacing=1, auto_scroll=True
                    ),
        ...
        def _update_ui():
            ...
            if analysis_just_completed:
                completion_snackbar = ft.SnackBar(
                    content=ft.Text(self.tr("status_completed_msg")),
            ...
            if self.progress_bar_ref.current:
                ...
                self.progress_bar_ref.current.value = (
            ...
            if self.start_button_ref.current:
                ...
                self.start_button_ref.current.text = (
                    self.tr("stop_button") if is_running else self.tr("start_button")
                )
                self.start_button_ref.current.icon = (
                    ft.icons.STOP if is_running else ft.icons.PLAY_ARROW
                )
                self.start_button_ref.current.tooltip = (
                    self.tr("stop_button_tooltip")
                    if is_running
                    else self.tr("start_button_tooltip")
                )
                self.start_button_ref.current.on_click = (
                    self._stop_analysis_clicked
                    if is_running
                    else self._start_analysis_clicked
                )

            results_exist = bool(self.view_model.get_detected_segments())
            if self.save_button_ref.current:
                self.save_button_ref.current.disabled = (
                    not enable_controls or not results_exist
                )

            # Enable copy button only if analysis is not running AND songs were identified
            if self.copy_comment_button_ref.current:
                self.copy_comment_button_ref.current.disabled = is_running or not bool(
                    self.view_model.get_identified_songs()
                )
            ...
            if self.songs_table_ref.current:
                ...
                for i, song_data in enumerate(identified_songs):
                    ...
                    title = song_data.get("title") or self.tr(
                        "unknown_title_placeholder"
                    )
                    artist = song_data.get("artist") or self.tr(
    ...
    def _translate_dynamic_status(self, status: str) -> str:
        ...
        match_elapsed = re.search(
            r"\(Elapsed: (\d{2,}:\d{2}:\d{2}|\d{1,2}:\d{2})\)", status
        )
        if match_elapsed:
    ...
    def _copy_youtube_comment_clicked(self, e):
        ...
        snack_bar = ft.SnackBar(content=ft.Text(snack_bar_msg), bgcolor=snack_bar_color)
    ...
    def _on_pick_file_result(self, e: ft.FilePickerResultEvent):
        if e.files:
            ...
            if self.file_path_ref.current:
                ...
                if self.source_type_ref.current:
                    self.source_type_ref.current.value = "file"
                self.page.update()
    ...
    def _get_config_from_ui(self) -> Dict[str, Any]:
        ...
        def get_numeric(ref, default, is_float=True):
            ...
            if ref == self.sing_ref_time_ref:
                label_key = "sing_ref_time_label"
            elif ref == self.non_sing_ref_time_ref:
                label_key = "non_sing_ref_time_label"
            elif ref == self.ref_duration_ref:
                label_key = "ref_duration_label"
            elif ref == self.hmm_threshold_ref:
                label_key = "hmm_thresh_label"
            elif ref == self.min_segment_duration_ref:
                label_key = "min_seg_dur_label"
            elif ref == self.min_segment_gap_ref:
                label_key = "min_seg_gap_label"
            elif ref == self.n_components_ref:
                label_key = "pca_comp_label"
            elif ref == self.min_duration_for_id_ref:
                label_key = "min_id_dur_label"
            else:
                label_key = ref.current.label if ref.current else "unknown_field"
            try:
                ...
                if ref.current:
                    ref.current.value = str(default)
                if self.page:
                    self.page.update()
                return default

        source_type = (
            self.source_type_ref.current.value
            if self.source_type_ref.current
            else "file"
        )
        config["file"] = (
            self.file_path_ref.current.value
            if source_type == "file" and self.file_path_ref.current
            else None
        )
        config["url"] = (
            self.url_ref.current.value
            if source_type == "url" and self.url_ref.current
            else None
        )
        config["output_dir"] = (
            self.output_dir_ref.current.value if self.output_dir_ref.current else "."
        )
        ...
        config["whisper_model"] = (
            self.whisper_model_ref.current.value
            if self.whisper_model_ref.current
            else "base"
        )
        config["enable_hpss"] = (
            self.enable_hpss_ref.current.value if self.enable_hpss_ref.current else True
        )
        config["gemini_api_key"] = (
            self.api_key_ref.current.value if self.api_key_ref.current else ""
        )
        config["save_results_json"] = (
            self.save_json_ref.current.value if self.save_json_ref.current else False
        )
        config["save_results_dataframe"] = (
            self.save_csv_ref.current.value if self.save_csv_ref.current else False
        )
        return config
